...
@Component
public class DailyMeetingTransformer implements MeetingTransformer {

  private final int recurrenceDuration;

  @Autowired
  public DailyMeetingTransformer(@Value("${calendar.recurrence.duration.events:180}") int recurrenceDuration) {
