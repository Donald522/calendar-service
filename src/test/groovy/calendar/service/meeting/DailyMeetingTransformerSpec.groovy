...
@Subject(DailyMeetingTransformer)
class DailyMeetingTransformerSpec extends Specification {

  private DateTimeFormatter formatter = DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm")

  def "Should create meetings daily"() {
    given:
    ...
    def transformer = new DailyMeetingTransformer(numberOfEvents)
    ...
    meetings[2].id == 1
    meetings[2].subId == 3
    meetings[2].fromTime == LocalDateTime.parse('2022-04-23 10:00', formatter)
    meetings[2].toTime == LocalDateTime.parse('2022-04-23 11:00', formatter)
  }
}
